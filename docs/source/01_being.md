...
The project of philosophy is to make clear what we are, to present for the understanding the concepts which underlie our Being, the Being that occurs when some pocket of the world turns on the rest and declares itself separate through the proclamation, _I am_. Philosophy should, in its rightful endeavor, provide the basis for understanding how this situation, that of the _am_, comes to be separate from the other types of Being. In essence, philosophy, if it is not to go the way of alchemy or phrenology, must answer the question: _what am I_?. 

The path before us is littered with questions the answers to which are not at all clear. We do not get very far towards understanding our nature when we begin with even the simplest of questions. When asking _What am I?_, we necessarily bring with us an expectation the answer will assume the form _I am x_, so that in order to answer this question we must first understand what type(s) of operands may be substituted for _x_ and remain intelligible. We must also hold fast to the uncertain notion that it may be the case there is no expression, within the structured forms of linguistic representation, that is capable of answering this question. Nevertheless, if there is to be an answer, it must necessarily be of the form _I am x_, so we proceed with its analysis, hoping that our fears will be assauged as we gain a clearer picture of how much language can say about what we are. 

The type of proposition represented with _I am x_ is a particualr case of a more general philosophical truth, one that can be uncovered by recognizing _am_ is a derivative of _is_, so that _I am x_, which might be rephrased more verbosely as _that which is me is x_, is really governed, at least in the limit, by the same algebra that governs simpler primitive terms captured symbollically by the proposition _this is x_. We thus must preface our answer to _what am I?_ with an answer to _what is this?_.
