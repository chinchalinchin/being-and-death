...
In the last three hundred years, a similar reckoning has been underway in philsophy; The artifacts of **Aristotelian** philosophy have been shattered in order to examine their constituent pieces and then reworked into grander schemes. A clear line of philosophers extending through **Descartes**, **Kant**, **Husserl** and **Heidegger** have begun to challenge the notions upon which philosophy itself is built, by applying the analytical eye to the most immediate of all datum, experience itself. 

There is an inherent problem with this method, which these thinkers have grappled with at great length, in that a investigation into Being will necessarily seek to investigate that which is investigating, i.e. ourselves. But by objectifying our Being and making it the subject of study, we necessarily lose its personal subjectivity, and render our object of study unapproachable, passing by like a ship in the night. When one attempts to engage with [phenomenology](#appearance-versus-existence), one must careful with the avenues of inquiries one selects to make clear and apparent the object of study, which in this case is no object at all, but the subject itself as pure subjectivity.
